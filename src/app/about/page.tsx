      ...
      <main className="px-4 md:px-8 lg:px-16">
        <section className="pt-4">
          ...
          <p className="font-inter font-light text-base text-[#888888] mb-4">
            ...
            Saint Seiya universe. Whether you're building a fan website, a
            mobile app, or just exploring data, this API serves as a
            comprehensive source for everything related to Saint Seiya.
          </p>
